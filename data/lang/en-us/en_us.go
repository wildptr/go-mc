...
var Map = map[string]string{
	...
	"translation.test.complex":                                   "Prefix, %s%2s again %s and %1s lastly %s and also %1s again!",
	...
	"demo.help.movement":                                         "Use the %1s, %2s, %3s, %4s keys and the mouse to move around",
	"demo.help.movementShort":                                    "Move by pressing the %1s, %2s, %3s, %4s keys",
	"demo.help.movementMouse":                                    "Look around using the mouse",
	"demo.help.jump":                                             "Jump by pressing the %1s key",
	"demo.help.inventory":                                        "Use the %1s key to open your inventory",
	...
	"difficulty.lock.question":                                   "Are you sure you want to lock the difficulty of this world? This will set this world to always be %1s, and you will never be able to change that again.",
	...
	"book.pageIndicator":                                         "Page %1s of %2s",
	"book.byAuthor":                                              "by %1s",
	...
	"container.repair.cost":                                      "Enchantment Cost: %1s",
	...
	"death.fell.accident.ladder":                                 "%1s fell off a ladder",
	"death.fell.accident.vines":                                  "%1s fell off some vines",
	"death.fell.accident.water":                                  "%1s fell out of the water",
	"death.fell.accident.generic":                                "%1s fell from a high place",
	"death.fell.killer":                                          "%1s was doomed to fall",
	"death.fell.assist":                                          "%1s was doomed to fall by %2s",
	"death.fell.assist.item":                                     "%1s was doomed to fall by %2s using %3s",
	"death.fell.finish":                                          "%1s fell too far and was finished by %2s",
	"death.fell.finish.item":                                     "%1s fell too far and was finished by %2s using %3s",
	"death.attack.lightningBolt":                                 "%1s was struck by lightning",
	"death.attack.lightningBolt.player":                          "%1s was struck by lightning whilst fighting %2s",
	"death.attack.inFire":                                        "%1s went up in flames",
	"death.attack.inFire.player":                                 "%1s walked into fire whilst fighting %2s",
	"death.attack.onFire":                                        "%1s burned to death",
	"death.attack.onFire.player":                                 "%1s was burnt to a crisp whilst fighting %2s",
	"death.attack.lava":                                          "%1s tried to swim in lava",
	"death.attack.lava.player":                                   "%1s tried to swim in lava to escape %2s",
	"death.attack.hotFloor":                                      "%1s discovered the floor was lava",
	"death.attack.hotFloor.player":                               "%1s walked into danger zone due to %2s",
	"death.attack.inWall":                                        "%1s suffocated in a wall",
	"death.attack.inWall.player":                                 "%1s suffocated in a wall whilst fighting %2s",
	"death.attack.cramming":                                      "%1s was squished too much",
	"death.attack.cramming.player":                               "%1s was squashed by %2s",
	"death.attack.drown":                                         "%1s drowned",
	"death.attack.drown.player":                                  "%1s drowned whilst trying to escape %2s",
	"death.attack.starve":                                        "%1s starved to death",
	"death.attack.starve.player":                                 "%1s starved to death whilst fighting %2s",
	"death.attack.cactus":                                        "%1s was pricked to death",
	"death.attack.cactus.player":                                 "%1s walked into a cactus whilst trying to escape %2s",
	"death.attack.generic":                                       "%1s died",
	"death.attack.generic.player":                                "%1s died because of %2s",
	"death.attack.explosion":                                     "%1s blew up",
	"death.attack.explosion.player":                              "%1s was blown up by %2s",
	"death.attack.explosion.player.item":                         "%1s was blown up by %2s using %3s",
	"death.attack.magic":                                         "%1s was killed by magic",
	"death.attack.even_more_magic":                               "%1s was killed by even more magic",
	"death.attack.message_too_long":                              "Actually, message was too long to deliver fully. Sorry! Here's stripped version: %s",
	"death.attack.wither":                                        "%1s withered away",
	"death.attack.wither.player":                                 "%1s withered away whilst fighting %2s",
	"death.attack.anvil":                                         "%1s was squashed by a falling anvil",
	"death.attack.anvil.player":                                  "%1s was squashed by a falling anvil whilst fighting %2s",
	"death.attack.fallingBlock":                                  "%1s was squashed by a falling block",
	"death.attack.fallingBlock.player":                           "%1s was squashed by a falling block whilst fighting %2s",
	"death.attack.mob":                                           "%1s was slain by %2s",
	"death.attack.mob.item":                                      "%1s was slain by %2s using %3s",
	"death.attack.player":                                        "%1s was slain by %2s",
	"death.attack.player.item":                                   "%1s was slain by %2s using %3s",
	"death.attack.arrow":                                         "%1s was shot by %2s",
	"death.attack.arrow.item":                                    "%1s was shot by %2s using %3s",
	"death.attack.fireball":                                      "%1s was fireballed by %2s",
	"death.attack.fireball.item":                                 "%1s was fireballed by %2s using %3s",
	"death.attack.thrown":                                        "%1s was pummeled by %2s",
	"death.attack.thrown.item":                                   "%1s was pummeled by %2s using %3s",
	"death.attack.indirectMagic":                                 "%1s was killed by %2s using magic",
	"death.attack.indirectMagic.item":                            "%1s was killed by %2s using %3s",
	"death.attack.thorns":                                        "%1s was killed trying to hurt %2s",
	"death.attack.thorns.item":                                   "%1s was killed by %3s trying to hurt %2s",
	"death.attack.trident":                                       "%1s was impaled by %2s",
	"death.attack.trident.item":                                  "%1s was impaled by %2s with %3s",
	"death.attack.fall":                                          "%1s hit the ground too hard",
	"death.attack.fall.player":                                   "%1s hit the ground too hard whilst trying to escape %2s",
	"death.attack.outOfWorld":                                    "%1s fell out of the world",
	"death.attack.outOfWorld.player":                             "%1s didn't want to live in the same world as %2s",
	"death.attack.dragonBreath":                                  "%1s was roasted in dragon breath",
	"death.attack.dragonBreath.player":                           "%1s was roasted in dragon breath by %2s",
	"death.attack.flyIntoWall":                                   "%1s experienced kinetic energy",
	"death.attack.flyIntoWall.player":                            "%1s experienced kinetic energy whilst trying to escape %2s",
	"death.attack.fireworks":                                     "%1s went off with a bang",
	"death.attack.fireworks.player":                              "%1s went off with a bang whilst fighting %2s",
	"death.attack.netherBed.message":                             "%1s was killed by %2s",
	"death.attack.netherBed.link":                                "Intentional Game Design",
	"death.attack.sweetBerryBush":                                "%1s was poked to death by a sweet berry bush",
	"death.attack.sweetBerryBush.player":                         "%1s was poked to death by a sweet berry bush whilst trying to escape %2s",
	...
	"stat.minecraft.time_since_death":                            "Since Last Death",
	...
	"inventory.hotbarSaved":                                      "Item toolbar saved (restore with %1s+%2s)",
	"inventory.hotbarInfo":                                       "Save toolbar with %1s+%2s",
	...
	"mount.onboard":                                              "Press %1s to dismount",
	...
	"commands.advancement.advancementNotFound":                   "No advancement was found by the name '%1s'",
	"commands.advancement.criterionNotFound":                     "The advancement %1s does not contain the criterion '%2s'",
	...
	"commands.worldborder.damage.amount.success":                 "Set the world border damage time to %s seconds",
